...
<%--    <div id="login">
        ...
        <asp:TextBox ID="TextBox_Email" CssClass="form-control" runat="server" placeholder="Email address" TextMode="Email"> </asp:TextBox>
    ...
    <asp:Label ID="Label_Besked" runat="server"> </asp:Label>--%>
     ...
     <div class="form-signin">
        ...
        <asp:TextBox ID="TextBox_Email" runat="server" placeholder="Skriv dit brugernavn her" required="Brugernavn mangler!" CssClass="form-control" ValidationGroup="login"></asp:TextBox>
