...
public partial class Rediger : System.Web.UI.Page
{
    ...
    protected void Button_RedigerBruger_Click(object sender, EventArgs e)
    {
           try
        {
            ...
            cmd.Connection = conn;
            //Sql sætningen
            cmd.CommandText = "UPDATE [Brugere] SET [Navn] = @navn, [Email] = @email, [Telefon] = @telefon, [Avatar] = @avatar, [Password] = @password WHERE [Id] = @id";
